...
The provided code creates a bunch of arrays containing words, and then randomly picks words out of them
to create a "mad lib".
 */
public class MadLibRandom
{
    public static void main(String[] args)
    {
        ...
        System.out.printf("yello, and there were colorful wildflowers all around. %s and %s\n", male, female );
        ...
        System.out.printf("\"Don't be such a(n) %s! We're going in. I think it looks willingly\n", noun2 );

...
/*
Download and finish the following code to practice writing function calls.
 */
public class FunctionCallAlphabet
{
    public static void main( String[] args )
    {
        ...
        i( 15 );    // pass it any integer and it will display a word beginning with I
        ...
        n("Nick");    // displays the word you pass it beginning with "N"
